<?php
        ...
        if($_POST['loginActive'] == '0'){       
            ...
            if(mysqli_num_rows($result) > 0){
                ...
                if(mysqli_query($link, $query)){
                    ...
                    $error =  "could not inserted into db";
                }
            }            
            ...
            // login, if user exist in database
            $query = "SELECT * FROM user WHERE `email` = '".mysqli_real_escape_string($link, $_POST['email'])."' LIMIT 1 ";
    ...
    if($_GET['action'] == 'postTweet'){
        ...
        if( $_POST['tweetContent'] == " " ){
            ...
            mysqli_query($link, "INSERT INTO tweets(`tweet`, `userid`, `date_time`) VALUES('".mysqli_real_escape_string($link, $_POST['tweetContent'])."', ".mysqli_real_escape_string($link, $_SESSION['id']).", NOW())");
